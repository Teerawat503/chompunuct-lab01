...
export default function ShowBook() {
  ...
  // กรองหนังสือตามค่าตัวกรองที่ถูกเลือก ฟิวเตอร์นั่นแหละ ตามโจทย์ข้อ 2
  const filteredBooks = BookList.filter((book) => {
    if (filter === "bestseller") return book.Bestseller; // ถ้าเลือก Bestseller ให้แสดงเฉพาะหนังสือที่มี Bestseller เป็น true
    if (filter === "flashsale") return book.Suggestions; // ถ้าเลือก Suggestions ให้แสดงเฉพาะหนังสือที่มี Suggestions เป็น true
    ...
    <>
      ...
      <div className="banner text-center my-6">
        <h1 className="text-3xl font-sans font-bold">
          ยินดีต้อนรับเข้าสู่ร้านขายหนังสือของ ชมพู่
        </h1>
              ...
              <tr key={item.Code} className="bg-white">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <div className="promotion flex flex-col space-y-2">
                    ...
                    {item.Suggestions && (
                      <span className="inline-block bg-red-600 text-white px-2 py-1 rounded-lg font-bold">
                        หนังสือขายดี
                      </span>
                    )}
                  </div>
